...
const WishlistPage: React.FC = () => {
  ...
  return (
    <div className="xl:px-34 relative left-0 top-0 min-h-screen bg-white px-4 md:mt-0 md:px-8 lg:px-24 2xl:px-64">
      <div className="container">
        <h1 className="text-md mx-auto my-10 w-full text-center font-medium md:text-xl">
          Wishlist
        </h1>
