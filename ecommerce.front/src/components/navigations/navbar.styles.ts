const navbar = {
  container:
    "relative w-full z-30 h-30 md:h-20 bg-white px-6 text-black md:px-8 lg:px-16 xl:px-32 2xl:px-64",
  mobileNav:
    "flex flex-col bg-white gap-2 h-full items-center justify-center md:hidden",
