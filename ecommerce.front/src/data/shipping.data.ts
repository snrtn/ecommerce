...
export const generateOrders = (): Order[] => [
  {
    ...
    locations: [
      { date: "12.7.2024", location: "Warehouse A", status: "Shipped" },
      {
        date: "14.7.2024",
        location: "Distribution Center",
        status: "In Transit",
      },
      { date: "18.7.2024", location: "Warehouse A" },
      { date: "20.7.2024", location: "Out for Delivery" },
      {
        date: "21.7.2024",
        location: "Customer's Address",
        status: "Delivered",
      },
      { date: "22.7.2024", status: "Return Requested" },
      { date: "23.7.2024", status: "Return Completed" },
      { date: "24.7.2024", status: "Return Rejected" },
      { date: "25.7.2024", status: "Refund Requested" },
      { date: "26.7.2024", status: "Refund Completed" },
      { date: "27.7.2024", status: "Refund Rejected" },
    ],
    paidPrice: 129.99,
    orderDate: "10.7.2024",
  ...
  },
  {
    ...
    locations: [
      { date: "10.7.2024", location: "Warehouse B", status: "Shipped" },
      {
        date: "12.7.2024",
        location: "Distribution Center",
        status: "In Transit",
      },
      { date: "14.7.2024", status: "Return Requested" },
      { date: "16.7.2024", status: "Return Rejected" },
      { date: "18.7.2024", status: "Refund Requested" },
      { date: "20.7.2024", status: "Refund Completed" },
      { date: "22.7.2024", status: "Refund Rejected" },
    ],
    paidPrice: 79.99,
    orderDate: "8.7.2024",
  ...
  },
  {
    ...
    locations: [
      { date: "8.7.2024", location: "Warehouse C", status: "Shipped" },
      {
        date: "10.7.2024",
        location: "Distribution Center",
        status: "In Transit",
      },
      { date: "15.7.2024", location: "Local Delivery Hub" },
      { date: "20.7.2024", location: "Out for Delivery" },
      { date: "22.7.2024", status: "Refund Requested" },
      { date: "24.7.2024", status: "Refund Completed" },
      { date: "26.7.2024", status: "Refund Rejected" },
      { date: "28.7.2024", status: "Return Requested" },
      { date: "30.7.2024", status: "Return Completed" },
      { date: "01.8.2024", status: "Return Rejected" },
    ],
    paidPrice: 59.99,
    orderDate: "6.7.2024",
  ...
  },
  {
    ...
    locations: [
      { date: "6.7.2024", location: "Warehouse D", status: "Shipped" },
      {
        date: "8.7.2024",
        location: "Distribution Center",
        status: "In Transit",
      },
      { date: "12.7.2024", location: "Out for Delivery" },
      {
        date: "17.7.2024",
        location: "Customer's Address",
        status: "Delivered",
      },
      { date: "20.7.2024", status: "Refund Requested" },
      { date: "22.7.2024", status: "Refund Rejected" },
      { date: "24.7.2024", status: "Return Requested" },
      { date: "26.7.2024", status: "Return Completed" },
      { date: "28.7.2024", status: "Return Rejected" },
    ],
    paidPrice: 49.99,
    orderDate: "4.7.2024",
  ...
  },
  {
    ...
    locations: [
      { date: "15.7.2024", location: "Warehouse E", status: "Shipped" },
      {
        date: "17.7.2024",
        location: "Distribution Center",
        status: "In Transit",
      },
      { date: "19.7.2024", status: "Return Requested" },
      { date: "21.7.2024", status: "Return Completed" },
      { date: "23.7.2024", status: "Return Rejected" },
      { date: "25.7.2024", status: "Refund Requested" },
      { date: "27.7.2024", status: "Refund Completed" },
      { date: "29.7.2024", status: "Refund Rejected" },
    ],
    paidPrice: 89.99,
    orderDate: "13.7.2024",
  ...
  },
  {
    ...
    locations: [
      { date: "18.7.2024", location: "Warehouse F", status: "Shipped" },
      {
        date: "20.7.2024",
        location: "Distribution Center",
        status: "In Transit",
      },
      { date: "24.7.2024", status: "Refund Requested" },
      { date: "26.7.2024", status: "Refund Rejected" },
      { date: "28.7.2024", status: "Return Requested" },
      { date: "30.7.2024", status: "Return Completed" },
      { date: "01.8.2024", status: "Return Rejected" },
  ...
  },
  {
    ...
    locations: [
      { date: "19.7.2024", location: "Warehouse G", status: "Shipped" },
      {
        date: "21.7.2024",
        location: "Distribution Center",
        status: "In Transit",
      },
      { date: "23.7.2024", status: "Return Requested" },
      { date: "25.7.2024", status: "Return Rejected" },
      { date: "27.7.2024", status: "Refund Requested" },
      { date: "29.7.2024", status: "Refund Completed" },
      { date: "31.7.2024", status: "Refund Rejected" },
    ],
    paidPrice: 59.99,
    orderDate: "17.7.2024",
  ...
  },
  {
    ...
    locations: [
      { date: "20.7.2024", location: "Warehouse H", status: "Shipped" },
      {
        date: "22.7.2024",
        location: "Local Delivery Hub",
        status: "In Transit",
      },
      { date: "25.7.2024", status: "Return Requested" },
      { date: "27.7.2024", status: "Return Rejected" },
      { date: "29.7.2024", status: "Refund Requested" },
      { date: "31.7.2024", status: "Refund Completed" },
      { date: "02.8.2024", status: "Refund Rejected" },
    ],
    paidPrice: 119.99,
    orderDate: "18.7.2024",
  ...
  },
  {
    ...
    locations: [
      { date: "21.7.2024", location: "Warehouse I", status: "Shipped" },
      {
        date: "23.7.2024",
        location: "Customer's Address",
        status: "Delivered",
      ...
      { date: "25.7.2024", status: "Refund Requested" },
      { date: "27.7.2024", status: "Refund Completed" },
      { date: "29.7.2024", status: "Return Requested" },
      { date: "31.7.2024", status: "Return Completed" },
      { date: "02.8.2024", status: "Return Rejected" },
    ],
    paidPrice: 69.99,
    orderDate: "19.7.2024",
  ...
  },
  {
    ...
    locations: [
      { date: "21.7.2024", location: "Warehouse J", status: "Shipped" },
      {
        date: "22.7.2024",
        location: "Distribution Center",
        status: "In Transit",
      ...
      { date: "23.7.2024", status: "Return Requested" },
      { date: "28.7.2024", status: "Return Completed" },
      { date: "30.7.2024", status: "Refund Requested" },
      { date: "01.8.2024", status: "Refund Completed" },
      { date: "03.8.2024", status: "Refund Rejected" },
    ],
    paidPrice: 99.99,
    orderDate: "20.7.2024",
